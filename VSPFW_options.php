		...
		<form method="post" action="options.php">
			<?php
			    ...
			    <table class="form-table">
			        ...
			        <tr valign="top">
			        	<th scope="row">Request Password:</th>
			        	<td>
			        		<div class="vspfw-option-group">
			        ...
			        <tr valign="top">
			        	<th scope="row">Brute Force Protection:</th>
			        	<td>
			        		<div class="vspfw-option-group">
			        			<h2>Brute Force Protection</h2>
			        			<div class="vspfw-option">
			        				<label for="vspfw_brute_force_protection_tries">Failed login tries:</label>
			        			...
			        			<div class="vspfw-option">
			        				<label for="vspfw_brute_force_protection_interval">Interval in seconds:</label>
			        ...
			        <tr valign="top">
			        	<th scope="row">Domain configuration:</th>
			        	<td>
				        	<div class="vspfw-option-group">
